...
#define LV_COLOR_DEPTH     32
      ...
      *=========================*/
      ...
      // 2022-09-22 AWe   bugfix: we need the prototypes for the buildin functions here
      #include <stddef.h>        // size_t
      #include <stdarg.h>        // va_list

      extern void * lv_malloc_builtin( size_t size );
      extern void * lv_realloc_builtin( void * p, size_t new_size );
      extern void lv_free_builtin( void * p );
      extern void lv_memset_builtin( void * dst, uint8_t v, size_t len );
      extern void * lv_memcpy_builtin( void * dst, const void * src, size_t len );
      extern void * lv_memcpy_builtin( void * dst, const void * src, size_t len );
      extern int lv_snprintf_builtin( char * buffer, size_t count, const char * format, ... );
      extern int lv_vsnprintf_builtin( char * buffer, size_t count, const char * format, va_list va );
      extern size_t lv_strlen_builtin( const char * str );
      extern char * lv_strncpy_builtin( char * dst, const char * src, size_t dest_size );
      ...
      *===================*/
      ...
      #define CUSTOM_FONT_DECLARE(font_name) extern lv_font_t font_name;

      #define LV_FONT_CUSTOM_DECLARE               \
               CUSTOM_FONT_DECLARE( font_7segment_72 )       \
               CUSTOM_FONT_DECLARE( font_7segment_36 )       \
               CUSTOM_FONT_DECLARE( font_7segment_22 )       \
               CUSTOM_FONT_DECLARE( font_montserrat_22 )     \
               CUSTOM_FONT_DECLARE( font_montserrat_16 )     \
               CUSTOM_FONT_DECLARE( font_montserrat_10 )     \
               CUSTOM_FONT_DECLARE( font_symbols_32 )        \
               CUSTOM_FONT_DECLARE( font_owicons_36 )        \
               CUSTOM_FONT_DECLARE( font_owicons_72 )        \
               CUSTOM_FONT_DECLARE( font_weathericons_36 )   \
               CUSTOM_FONT_DECLARE( font_weathericons_72 )

      // #define USE_OWFONT

      /*Always set a default font*/
      #if BUILD_MY_PROJECT
         #define LV_FONT_DEFAULT &font_montserrat_16
      #else
      ...
      *In these languages characters should be replaced with an other form based on their position in the text*/
      ...
      #define LV_USE_TABVIEW      1		// not useable, display too slow
      ...
      #if BUILD_MY_PROJECT
         #define LV_USE_PROJECT_THEME    1
         #define LV_USE_THEME_DEFAULT    0
      #else
         #define LV_USE_PROJECT_THEME    0
         #define LV_USE_THEME_DEFAULT    1
      #endif

      #if LV_USE_THEME_DEFAULT || LV_USE_PROJECT_THEME
